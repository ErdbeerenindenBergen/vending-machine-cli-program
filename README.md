...
This project was completed as a capstone project for Tech Elevator's Java Bootcamp.
It is a command line interface program that functions as a Vending Machine.

All requirements and all optional requirements are met (A hidden menu item--as 
requested below--was included.)

Unit Tests were written and are included in the "Test" directory to test 100% of classes, 
100% of methods, and 100% of lines of code.
